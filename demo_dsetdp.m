...
function demo_dsetdp()
    ...
    nsample=0.036;
    th_std=0.1;
    [rate_nmi,rate_acc]=dset_dp_auto(idx,nsample,th_std,flag_tsne);
    rate_nmi
    mean(rate_nmi)
    rate_acc
    mean(rate_acc)
...
function [rate_nmi,rate_acc]=dset_dp_auto(idx,nsample,th_std,flag_tsne)
